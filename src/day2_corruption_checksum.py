...
def second(table):
    ...
    for row in table:
        ...
        def chk(start_idx):
            for idx2 in range(start_idx + 1, len(ordered)):
                div = ordered[idx2] / ordered[start_idx]
                int_div = int(div)
                if div == int_div:
                    return int_div
            return 0
...
if __name__ == '__main__':
    ...
    table = [[278, 1689, 250, 1512, 1792, 1974, 175, 1639, 235, 1635, 1690, 1947, 810, 224, 928, 859],
